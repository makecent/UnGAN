...
data = dict(
    ...
    train=dict(
        ...
        times=100,
        dataset=dict(
            type=dataset_type, imgs_root='./datasets/cifar_train', pipeline=train_pipeline)),
    val=dict(type=dataset_type, imgs_root='./datasets/cifar_train', pipeline=val_pipeline))
